...
#ifndef OPEN_SPIEL_GAMES_RENJU_H_
#define OPEN_SPIEL_GAMES_RENJU_H_
...
inline constexpr int kNumRows = 15;
inline constexpr int kNumCols = 15;
inline constexpr int kNumCells = kNumRows * kNumCols;
inline constexpr int kCellStates = 1 + kNumPlayers;

inline constexpr int kNumberStates = 1e9;
...
class RenjuState : public State {
 ...
 private:
  bool HasLine(Player player) const;
  bool HasLineFrom(Player player, int row, int col) const;  // Does this player have a five?
...
#endif  // OPEN_SPIEL_GAMES_RENJU_H_
